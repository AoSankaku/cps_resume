...
・このツールの作成者は#コンパスを引退しましたが、このツールの更新は続ける予定です。<br>
　キャラクターを追加してほしいなどのリクエストが有りましたら、このページ下部のフォームまでご連絡ください。<br>
　ただし、モチベーションの問題で新機能などの追加は行わないものと思ってください（致命的な不具合などには対応いたします）。<br>
## Changelog
### v1.0.11<br>
【不具合対応】<br>
